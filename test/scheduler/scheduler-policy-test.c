...
int main(void)
{
	CHECK(scheduler_parse_mode(NULL) == SCHEDULER_MMCSS);
	CHECK(scheduler_parse_mode("mmcss") == SCHEDULER_MMCSS);
	CHECK(scheduler_parse_mode("auto") == SCHEDULER_AUTO);
	CHECK(scheduler_parse_mode("off") == SCHEDULER_OFF);
	CHECK(scheduler_parse_mode("ccd") == SCHEDULER_OFF);
	CHECK(scheduler_parse_mode("") == SCHEDULER_OFF);
	test_hybrid();
	test_multi_llc();
	test_single_llc();
